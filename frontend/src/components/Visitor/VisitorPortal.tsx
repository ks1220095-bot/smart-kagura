          ...
          <form style={{ maxWidth: '800px', margin: '0 auto' }} onSubmit={(e) => { e.preventDefault(); handleNextStep(); }}>
            ...
            <div className="card">
              ...
              <div style={{ fontSize: '0.85rem', color: 'var(--color-urushi-light)', lineHeight: '1.6' }}>
                ...
                <p style={{ color: '#d3381c', fontWeight: 'bold' }}>・例年11月中（七五三の時期）、1月1日～1月15日頃（お正月の時期）は混みあうことが予想されております。境内裏手に駐車可能台数 約12台の駐車場を設けておりますが、満車の際は、お近くのコインパーキングにお停めいただくか、公共交通機関をご利用の上、ご参拝賜りますようお願い申し上げます。</p>
